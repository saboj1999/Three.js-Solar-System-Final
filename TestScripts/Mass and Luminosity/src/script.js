...
const updateSunMass = () =>
{
    sunObject.mass = sunMaterial.emissiveIntensity * sunDefaultObject.mass
}
const updateSunLumonosity = () =>
{
    sunMaterial.emissiveIntensity = sunObject.mass / sunDefaultObject.mass
}
...
gui.add(sunMaterial, 'emissiveIntensity')
    .min(.1)
    .max(5)
    .step(.01)
    .onFinishChange(updateSunMass)
    .name('Lumonosity')
gui.add(sunObject, 'mass')
    .min(.08*sunDefaultObject.mass)
    .max(20*sunDefaultObject.mass)
    .step(100000)
    .onFinishChange(updateSunLumonosity)
    .name('Mass')
